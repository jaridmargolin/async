...
var Deferred$1 =
/*#__PURE__*/
function (_LazyPromise) {
  _inherits(Deferred, _LazyPromise);

  function Deferred() {
    _classCallCheck(this, Deferred);

    return _possibleConstructorReturn(this, _getPrototypeOf(Deferred).apply(this, arguments));
  }
...
/*#__PURE__*/
function (_LazyPromise) {
  _inherits(EventListener, _LazyPromise);
  ...
  function EventListener(target, event) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(EventListener).call(this));
    ...
    _defineProperty(_assertThisInitialized(_this), "_onEvent", function (evt) {
...
export { Deferred$1 as Deferred, EventListener, EventListenerStatus, Deferred as LazyPromise, BasePromise as Promise, Timer, TimerStatus };
